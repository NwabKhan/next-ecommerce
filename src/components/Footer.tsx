...
const Footer = () => {
  return (
    <div className='py-24 px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-34 bg-gray-100 text-sm mt-24 '>
      {/* TOP  */}
      <div className='flex  flex-col md:flex-row justify-between gap-24'>
        ...
        <div className=' w-full md:w-1/2 lg:w-1/4 flex flex-col gap-8 '>
          ...
          <p>Mohallah Sherani wala Taunsa Sharif District DG-Khan</p>
        ...
        <div className='flex'>
          ...
          <button className='w-1/4 bg-Haseeb text-white'>Join</button>
          </div>
      ...
      <div className='flex flex-col md:flex-row items-center justify-between gap-8 mt-16'>
        <div className=''>© 2024 Haseeb Shop</div>
